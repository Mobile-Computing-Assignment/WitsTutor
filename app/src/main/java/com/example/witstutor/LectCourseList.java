...
public class LectCourseList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lectcourselist);
        ...
        ListView l = findViewById(R.id.lectCourseListLV);
        ...
        l.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent in = new Intent(LectCourseList.this,LectCreateApplication.class);
    ...
    public void processFetchCourses(String output) {
        ...
        try {
            ...
            if(test.getString("COURSE_NAME").equals("0")) {
                ...
                ArrayAdapter<String> mAdapter = new ArrayAdapter<>(LectCourseList.this, android.R.layout.simple_list_item_1, myList);
